...
repos=(
    ...
    oracle-linux-manager-client-release-el8
    oracle-linux-manager-client-release-el7
    oraclelinux-automation-manager-release-el8
    oracle-spacewalk-server-release-el7
    oracle-spacewalk-client-release-el8
    ...
    oracle-instantclient-release-el7
    oracle-release-el8
    oracle-release-el7
